...
export const APPEAL_POINTS: Record<string, AppealPoint[]> = {
  ...
  cmt5s5e210002135d0l5y6eq9: [
    {
      title: "비즈니스 플로우·정책 설계 경험",
      body: "서비스의 비즈니스 플로우와 정책을 직접 설계해본 경험을 구체적으로 보여주세요. 정책이 실제 화면과 어떻게 연결되는지까지 담으면 좋아요.",
      sourceQuote:
        "비즈니스 플로우 및 정책 설계",
    },
    {
      title: "프로세스 기반 화면 설계 능력",
      body: "복잡한 업무 프로세스를 기준으로 화면 흐름을 설계해본 경험을 보여주세요. Figma로 직접 화면을 그려본 사례면 더 좋아요.",
      sourceQuote:
        "프로세스 기반의 화면 설계",
    },
    {
      title: "데이터 기반 서비스 운영 경험",
      body: "데이터를 분석해 서비스 운영에 반영해본 경험을 정리해주세요. AI나 새로운 기술에 대한 관심도 함께 드러내면 좋아요.",
      sourceQuote:
        "데이터 분석 및 서비스 운영",
    },
  ],
