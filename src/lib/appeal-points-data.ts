...
export const APPEAL_POINTS: Record<string, AppealPoint[]> = {
  ...
  cmucoueju0002rt3zwd8y4ep9: [
    {
      title: "AI 도구로 디자인 워크플로우 개선한 경험",
      body: "AI 툴을 활용해 디자인 워크플로우 자체를 설계하고 개선해본 경험을 구체적으로 보여주세요.",
      sourceQuote: "AI 툴을 활용해 디자인 워크플로우를 직접 설계하고 개선한 경험이 있으신 분",
    },
    {
      title: "멀티플랫폼 디자인 제약 이해한 경험",
      body: "태블릿·앱·웹처럼 서로 다른 플랫폼 환경의 디자인 제약을 이해하고 실무에 적용해본 경험을 보여주세요.",
      sourceQuote:
        "태블릿·앱·웹 등 멀티 플랫폼 환경에서의 디자인 제약을 이해하고 실무에 적용해 본 경험이 있으신 분",
    },
    {
      title: "데이터 근거로 디자인을 설득한 경험",
      body: "데이터와 사용자 인사이트를 근거로 디자인 의사결정을 설명하고 동료를 설득한 경험을 보여주세요.",
      sourceQuote: "데이터와 사용자 인사이트를 근거로 디자인 의사결정을 설명하고 설득할 수 있는 분",
    },
  ],
  // OVERDARE
