...
const COMPANY_ANALYSIS: Record<string, CompanyAnalysisData> = {
  웨이브: {
    ...
    domainSecondary: "SK텔레콤과 방송 3사가 합작해 만든 국내 대표 OTT 플랫폼 '웨이브'를 운영해요. 실시간 방송과 VOD를 아우르는 콘텐츠 스트리밍 서비스예요.",
    domainKeywords: ["OTT", "미디어 스트리밍", "라지스크린"],
    problemLede: "TV부터 모바일까지 다양한 화면에서 일관되고 매끄러운 시청 경험을 만드는 게 핵심 문제예요.",
    problemRest: "iOS·Android·Web·TV 전체를 아우르는 디자인 시스템으로 서비스 전반의 완성도를 높여요.",
  },
  화이트스캔: {
    companyUrl: "https://whitescan.com",
    designBlogUrl: null,
    domainPrimary: "AI · 공간 빅데이터",
    domainSecondary: "공간 빅데이터 기반 AI 플랫폼과 사이버 위협 인텔리전스 플랫폼을 만드는 기업이에요.",
    domainKeywords: ["AI 플랫폼", "공간 데이터", "사이버보안"],
    problemLede: "복잡한 데이터와 분석 결과를 직관적으로 이해할 수 있는 화면으로 설계하는 게 핵심 문제예요.",
    problemRest: "공간 데이터 시각화부터 위협 인텔리전스 대시보드까지, 전문 영역의 정보를 쉽게 풀어내는 프로덕트를 만들어요.",
  },
  아이브코리아: {
    companyUrl: null,
    designBlogUrl: null,
    domainPrimary: "엔터테인먼트 · 팬덤 플랫폼",
    domainSecondary: "스타쉽엔터테인먼트 소속 아티스트(아이브 등)와 관련된 디지털 서비스를 개발하는 조직이에요.",
    domainKeywords: ["팬덤 서비스", "엔터테인먼트", "디지털 콘텐츠"],
    problemLede: "팬들이 아티스트와 더 가깝게 소통하고 콘텐츠를 즐길 수 있는 디지털 경험을 만드는 게 핵심 문제예요.",
    problemRest: "IP의 감성을 해치지 않으면서도 사용성 좋은 서비스 화면을 설계해요.",
  },
  마이베네핏: {
    companyUrl: "https://www.mybenefit.co.kr",
    designBlogUrl: null,
    domainPrimary: "헬스케어 · 웰니스",
    domainSecondary: "디지털 헬스케어 플랫폼으로 개인 맞춤형 건강관리 서비스와 가상 코칭 솔루션 'Virtual Mate'를 제공해요.",
    domainKeywords: ["디지털 헬스케어", "가상 코칭", "맞춤형 건강관리"],
    problemLede: "개인마다 다른 건강 상태와 목표에 맞춘 맞춤형 관리 경험을 설계하는 게 핵심 문제예요.",
    problemRest: "동작인식 기술과 가상 코칭을 결합해 누구나 쉽게 따라할 수 있는 건강관리 UX를 만들어요.",
  },
  멜: {
    companyUrl: null,
    designBlogUrl: null,
    domainPrimary: "AI · 소셜",
    domainSecondary: "하이퍼커넥트 출신 창업자와 팀이 만드는 AI 캐릭터 기반 소셜 엔터테인먼트 플랫폼이에요.",
    domainKeywords: ["AI 캐릭터", "소셜 플랫폼", "글로벌 서비스"],
    problemLede: "사용자가 AI 캐릭터와 자연스럽고 즐겁게 소통할 수 있는 경험을 만드는 게 핵심 문제예요.",
    problemRest: "빠르게 실험하며 제품 화면을 만들고 검증하는 초기 단계 스타트업이에요.",
  },
  케이존: {
    companyUrl: "https://deallo.ai",
    designBlogUrl: null,
    domainPrimary: "B2B SaaS · AI",
    domainSecondary: "미국 역물류(반품·재고) 시장의 비효율을 데이터와 AI로 해결하는 B2B 플랫폼 'Deallo.ai'를 만들어요.",
    domainKeywords: ["역물류", "AI 에이전트", "B2B SaaS"],
    problemLede: "복잡한 반품·재고 관리 전 과정을 AI Agent가 처리하고, 그 판단을 사용자가 신뢰할 수 있게 만드는 게 핵심 문제예요.",
    problemRest: "관리·매입·판매·운송 전 주기를 아우르는 UX·UI를 설계해요.",
  },
  한화생명: {
  ...
  "티오더": {
    companyUrl: "https://www.torder.com",
    designBlogUrl: null,
    domainPrimary: "외식테크 · 매장 솔루션",
    domainSecondary: "식당 매장의 주문·결제부터 사장님 운영까지 아우르는 태블릿 기반 매장 솔루션을 만드는 외식테크 기업이에요.",
    domainKeywords: ["외식테크", "태블릿 POS", "매장 솔루션"],
    problemLede: "매장 태블릿부터 사장님앱까지, 여러 기기를 오가며 매장을 운영하는 사장님의 번거로움을 줄이는 게 핵심 문제예요.",
    problemRest: "오더 태블릿, 마스터 태블릿, 사장님앱을 하나의 일관된 경험으로 설계해요.",
  },
  "OVERDARE": {
    companyUrl: "https://overdare.com",
    designBlogUrl: null,
    domainPrimary: "게임 · UGC 플랫폼",
    domainSecondary: "크래프톤과 네이버제트가 함께 만든 모바일 UGC(사용자 제작 콘텐츠) 플랫폼이에요. 생성형 AI와 언리얼 5 엔진으로 누구나 게임 콘텐츠를 제작할 수 있어요.",
    domainKeywords: ["UGC 플랫폼", "생성형 AI", "글로벌 신흥시장"],
    problemLede: "저사양 기기와 제한된 네트워크 환경에서도 쾌적하게 동작하는 UI를 만드는 게 핵심 문제예요.",
    problemRest: "UI를 직접 만드는 동시에 제작자를 위한 샌드박스 UI 시스템도 함께 설계해요.",
  },
  "OmniCraft Labs": {
    companyUrl: null,
    designBlogUrl: null,
    domainPrimary: "게임 · 액션 RPG",
    domainSecondary: "크래프톤의 프로덕션 스튜디오로, 언리얼 엔진 5로 현대풍 오컬트 액션 RPG를 개발하고 있어요.",
    domainKeywords: ["액션 RPG", "언리얼 엔진", "크래프톤 계열사"],
    problemLede: "강렬하고 몰입도 높은 스타일리시 액션에 어울리는 직관적인 UI/UX를 설계하는 게 핵심 문제예요.",
    problemRest: "HUD, 메뉴, 인벤토리 등 전반적인 UI를 기획부터 구현 방향까지 함께 설계해요.",
  },
  "CTK": {
    companyUrl: "https://www.ctkclip.com",
    designBlogUrl: null,
    domainPrimary: "뷰티 · B2B 플랫폼",
    domainSecondary: "화장품 개발 경험이 없는 누구나 브랜드를 만들 수 있도록 돕는 디지털 뷰티 플랫폼 CTKCLIP.COM을 운영해요. 수천 개의 원료·패키지·포뮬러 데이터를 디지털화했어요.",
    domainKeywords: ["뷰티 플랫폼", "K-뷰티", "B2B SaaS"],
    problemLede: "화장품 개발 경험이 없는 브랜드 크리에이터도 쉽게 쓸 수 있는 플랫폼 경험을 만드는 게 핵심 문제예요.",
    problemRest: "메인부터 상품 상세, 결제까지 주요 퍼널을 데이터 기반으로 개선하고 디자인 시스템으로 일관성을 관리해요.",
  },
  "바이오리서치에이아이": {
    companyUrl: "https://bio-research.ai",
    designBlogUrl: null,
    domainPrimary: "AI · 바이오테크",
    domainSecondary: "AI 기반 바이오·제약 데이터베이스 및 인텔리전스 솔루션 기업이에요. 전 세계 제약사·바이오텍과 투자기관의 의사결정을 지원하는 플랫폼을 18개국 이상의 고객에게 제공해요.",
    domainKeywords: ["바이오 AI", "데이터 시각화", "B2B SaaS"],
    problemLede: "차트와 통계로 가득한 복잡한 제약바이오 데이터를 누구나 빠르게 이해하도록 만드는 게 핵심 문제예요.",
    problemRest: "프로덕트 디자인과 브랜드 디자인을 함께 아우르며, AI 도구로 디자인 워크플로우 자체도 자동화해요.",
  },
  "폴리큐브": {
    companyUrl: "http://polycube.co.kr",
    designBlogUrl: null,
    domainPrimary: "IT/서비스 · 모바일 솔루션",
    domainSecondary: "OK Cashbag 운영과 모바일 서비스·컨텐츠, SI/SM 사업을 하는 2001년 설립 IT 기업이에요.",
    domainKeywords: ["모바일 솔루션", "SI/SM", "OK캐쉬백"],
    problemLede: "성격이 다른 여러 서비스의 UI/UX를 동시에 완성도 있게 만드는 게 핵심 문제예요.",
    problemRest: "기존 서비스 운영과 신규 서비스 UI/UX를 함께 다루는 소규모 디자인실에서 일해요.",
  },
  "알라딘": {
    companyUrl: "https://www.aladin.co.kr",
    designBlogUrl: null,
    domainPrimary: "커머스 · 온라인서점",
    domainSecondary: "대한민국 대표 온라인 서점 서비스예요. 25년 이상 꾸준히 성장하며 수백만 명의 고객이 사용하는 모바일 앱과 웹 서비스를 운영해요.",
    domainKeywords: ["온라인서점", "이커머스", "웹 퍼블리싱"],
    problemLede: "오래된 서비스에 신규 기능과 프로모션을 계속 얹으면서도 매끄러운 경험을 유지하는 게 핵심 문제예요.",
    problemRest: "디자인부터 HTML/CSS/JS 퍼블리싱까지 한 사람이 완결하는 구조라 웹 구현 이해도가 특히 중요해요.",
  },
  "올리브영": {
    companyUrl: "https://www.oliveyoung.co.kr",
    designBlogUrl: null,
    domainPrimary: "유통 · 헬스앤뷰티",
    domainSecondary: "CJ그룹 계열의 국내 1위 헬스앤뷰티(H&B) 스토어예요. 오프라인 매장과 온라인몰을 함께 운영하며, 최근 US·글로벌몰로 해외 시장까지 확장하고 있어요.",
    domainKeywords: ["헬스앤뷰티", "글로벌 이커머스", "CJ그룹"],
