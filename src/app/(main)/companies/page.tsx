      ...
      <div className="flex flex-col gap-1">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <Link
            ...
            className="inline-flex shrink-0 items-center gap-1 rounded-[14px] bg-neutral-200 px-4 py-2 text-sm font-medium text-neutral-500 transition-colors hover:bg-neutral-300 hover:text-neutral-600 active:scale-[0.95]"
          >
            나의 관심기업 보기
